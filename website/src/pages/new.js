...
//                       }}
//                       className={`px-4 py-2 rounded-lg shadow-btn ${
...
//           </p>
//           <p>
//             <strong>WhatsApp:</strong> {country.flag} {country.dial} {formData.whatsapp || "—"}
//           </p>
//           <p>
//             <strong>Date:</strong> {selectedDay.toDateString()}
//           </p>
//           <p>
//             <strong>Time:</strong> {selectedSlot ? formatSlot(selectedSlot) : "—"}
//           </p>
//           <p>
//             <strong>Timezone:</strong> {country.name} ({country.tz})
//           </p>
//           <p>
